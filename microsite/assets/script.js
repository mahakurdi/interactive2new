...
secondGame.style.display = "block";
        ...
        // dad.style.left = window.innerWidth / 2 + "px"
        // dad.style.top = window.innerHeight / 2 + "px"
        // kid.style.left= window.innerWidth / 2 + "px"
        // kid.style.top= window.innerWidth / 2 + "px"
        // mom.style.left= window.innerWidth / 2 + "px"
        // mom.style.top= window.innerWidth / 2 + "px"
      }
...
// dragElement(document.getElementById("SecondGame"));
